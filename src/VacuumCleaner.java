...
public class VacuumCleaner {
    ...
    // method that runs the vacuum around the squares for 100 time intervals
    ...
    public static int runVacuum(double s, double p, boolean[] isDirty) {
        ...
        // vacuum runs for 100 time steps
        for(int i = 0; i < 100; i++) {
            ...
            if(chanceCorrect <= p) {
                ...
                // if square isn't dirty, move the vacuum
                    ...
                    if(isForward && square < 3) square++;
                    else if(!isForward && square > 0) square--;
                    else if(isForward && square == 3) {
                        isForward = false;
                        square --;
                    } else if(!isForward && square == 0) {
                        isForward = true;
                        square++;
